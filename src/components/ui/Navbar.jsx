    ...
    <header className={`${scrolledNavbar? "shadow-md":"shadow-none"} ${isClicked? "shadow-none":"shadow-md"} px-8 md:px-16 py-4 sticky top-0 z-20 bg-white bg-opacity-10 backdrop-blur-sm`}>
      <nav className="w-full flex justify-between items-center">
        ...
        <ul className={`${isClicked? "top-16":"-top-64"} absolute flex flex-col md:flex-row md:static gap-4 md:gap-16 left-0 w-full md:w-auto py-4 md:py-0 bg-white md:bg-opacity-0 bg-opacity-10 backdrop-blur-sm md:backdrop-blur-none`}>
          <li>
            <Link to="/" onClick={()=>setMenu('home')} className={`${ menu == 'home' ? " md:after:w-[100%]" : " md:after:w-[0%] md:hover:after:w-[100%]"} relative cursor-pointer px-8 md:px-0 md:py-2 md:after:content-[''] md:after:bg-darkPurple md:after:h-1 md:after:w-[0%] md:after:absolute md:after:left-0 md:after:bottom-0 md:after:rounded-lg md:after:duration-300`}>
              Home
            </Link>
            {/* <NavLink to="/" className={({ isActive, isPending }) => isPending ? "" : isActive ? "relative cursor-pointer px-8 md:px-0 md:py-2 md:after:content-[''] md:after:bg-darkPurple md:after:h-1 md:after:w-[100%] md:after:absolute md:after:left-0 md:after:bottom-0 md:after:rounded-lg md:after:duration-300" : "relative cursor-pointer px-8 md:px-0 md:py-2 md:after:content-[''] md:after:bg-darkPurple md:after:h-1 md:after:w-[0%] md:after:absolute md:after:left-0 md:after:bottom-0 md:after:rounded-lg md:after:duration-300 md:hover:after:w-[100%]"}>
              Home
            </NavLink> */}
          </li>
          <li>
