...
export default function navbar() {
  ...
  return (
    <header
      ...
      } px-8 md:px-16 py-4 sticky top-0 z-20 bg-white bg-opacity-10 backdrop-blur-sm`}
    >
      <nav className="w-full flex justify-between items-center">
        ...
        <ul
          ...
          } absolute flex flex-col md:flex-row md:static gap-4 md:gap-16 left-0 w-full md:w-auto py-4 md:py-0 bg-white md:bg-opacity-0 bg-opacity-10 backdrop-blur-sm md:backdrop-blur-none`}
        >
          <li>
            <NavLink
              to="/"
        ...
        <div
          className={`${
            isClicked ? "top-[200px]" : "-top-64"
          } w-full md:w-auto flex gap-6 md:static absolute left-0 px-8 md:px-0 py-4 md:py-0 bg-white bg-opacity-10 md:bg-opacity-0 backdrop-blur-sm md:backdrop-blur-none shadow-md  md:shadow-none`}
        >
